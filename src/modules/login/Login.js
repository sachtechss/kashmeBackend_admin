    ...
    return (<div className="gx-login-container">
      <div className="gx-login-content">
        ...
        <div className="gx-mb-4 gx-text-center">
          <h2 style={{'color':'#261f71',fontWeight:'600',marginBottom:'3.5rem',fontSize:'3rem'}}>{langString.loginHead}</h2>
        </div>
        <Form onSubmit={this.handleSubmit} className="gx-login-form gx-form-row0">
          ...
          <FormItem>
            ...
            <Link className="gx-login-form-forgot pull-right" style={{fontWeight:'bold',fontStyle:'italic',color:'#7b789a'}} to="/forgot">Forgot password?</Link>
